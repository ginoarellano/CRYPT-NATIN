...
1.  **Normalization**: The input is sanitized to ensure all characters are compatible with the Baybayin cipher logic.
2.  **Conversion**: Characters are mapped to numerical values, followed by a +3 Caesar shift.
3.  **Mirroring**: The resulting number string is reversed to create the final encrypted code.
4.  **Decryption**: The process is fully reversible, allowing users to convert numeric codes back into readable text.
